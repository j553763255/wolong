    ...
    */
    public function enableSecurity($security_class = null)
    {
        if ($security_class instanceof Smarty_Security) {
            ...
            throw new SmartyException("Proving '" . get_class($security_class) . "' must extend Smarty_Security.");
        }
        ...
        if (!class_exists($security_class)) {
            ...
            throw new SmartyException("Proving '$security_class' must extend Smarty_Security.");
        } else {
