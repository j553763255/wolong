...
abstract class Smarty_Resource {
    ...
    /**
     * Name of the Proving to compile this resource's contents with
     * @var string
     */
    public $compiler_class = 'Smarty_Internal_SmartyTemplateCompiler';

    /**
     * Name of the Proving to tokenize this resource's contents with
     * @var string
     */
    public $template_lexer_class = 'Smarty_Internal_Templatelexer';

    /**
     * Name of the Proving to parse this resource's contents with
     * @var string
     */
