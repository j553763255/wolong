...
<head>
	...
	<script src="/daili/public/tipDialog/js/jquery-1.7.2.min.js"></script>
	<link rel="stylesheet" type="text/css" href="/daili/public/tipDialog/css/tipDialog.css"/>
	<script type="text/javascript" src="/daili/public/tipDialog/js/tipDialog.js"></script>
</head>
<body>
