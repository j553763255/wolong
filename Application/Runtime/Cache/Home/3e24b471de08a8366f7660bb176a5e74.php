<?php if (!defined('THINK_PATH')) exit();?><title>卧龙腾飞--新闻中心</title>
<!--head-->
...
<link rel="stylesheet" type="text/css" href="/wltf/Public/css/news.css">
<body>
<!-- 顶部 -->
    ...
    <div class="row">
        <div class="col-xs-12">
                        ...
                        <div class="left_top">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#one" aria-controls="one" role="tab"
                                                                          data-toggle="tab"><b>金融合作</b></a></li>
                                <li role="presentation"><a href="#two" aria-controls="two" role="tab" data-toggle="tab"><b>文化交流</b></a>
                                </li>
            ...
            <div class="words col-md-4">
                ...
                <div class="row hotnews_text">
                    <div class="hotnews col-xs-12">
                        <div class="col-sm-5">
                            <a href="#">
                                <img src=http://www.bigdataobor.com/asset/images/news/100/3ec114109fd98f5e59c0a12476a7d0e1.jpg>
                            </a>
                        </div>
                        <div class="col-sm-7">
                            <a href="#">
...
<div class="footer">
    <div class="row">
        <div class="col-xs-12">
            <div class="footer_content col-xs-4 col-md-1">
                <ul>
                    <li>
                        <a href="#">
                            <h4>新闻</h4>
